...
ステータス: **実装中 (Phase1〜6 完了 / Phase7 進行中: 画像圧縮 (Step4) 実装完了、`v0.1.2` タグ push (Step5) 待ち 2026-05-01)** / 開始日: 2026-04-30
...
- Step4 のコミット HEAD に `v0.1.2` タグを打って push
- Bitrise の `release` Workflow が緑化、TestFlight Internal Testing に `v0.1.2` が到達
